...
final class InboxEndpointsTest extends AuthTestCase
{
    ...
    private function seedCapture(string $captureId, string $name = 'Test ürünü'): int
    {
        $payload = [
            ...
            'qty' => 5,
            'source' => ['platform' => '1688', 'external_id' => 'e-' . $captureId, 'url' => 'https://detail.1688.com/offer/1.html'],
            'raw' => ['title' => $name . ' 原文'],
            'normalized' => ['name' => $name, 'price_yuan' => '3.50', 'images' => []],
        ];
