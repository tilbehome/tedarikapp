...
| F30 | GTİP / gümrük ve ithalat sınıflandırma motoru (M23) — taslak: [f30](fikirler/f30-gtip-motoru.md) · PM değerlendirmesi: [gtip-m23](arastirma/gtip-m23-degerlendirme.md) | **v1 DIŞI** — v1 canlıya çıktıktan sonra kendi mini tanım fazıyla açılır (PM). Ürün Sahibi'nin §8 sorusunu yanıtlaması ön şart |
